...
<head>
    ...
    <link rel="stylesheet" href="../css/scrapshop.css">
</head>
...
?>
            ...
            <form method="post">
                ...
                <div class="formSelect1">
                    ...
                    <select class="select2" name="flocation">
                        <option class="option" selected value="*">ART</option>
                ...
                <div class="formSelect1">
                    ...
                    <select class="select2" name="fstatus">
                        <option class="option" selected value="*">METAL</option>
    ...
    <?php
    $sql = "select product.*,category.category from product, category where product.category_id=category.id and status=1 and section=0";
